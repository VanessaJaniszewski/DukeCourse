...
public class VigenereBreaker222 {
	...
	// mapping of language names to language dictionary
		...
		private void readDict(String lang) {
			String path = "C:\\Users\\Vanes\\eclipse-workspace\\ZDuke\\src\\Week4\\dictionaries\\"+lang;
	     ...
	     */
	    public void breakVigenere (String name) {
	        String input = new FileResource().asString();
	        breakForAllLanguages(input);
	        
	        String dec = breakForLanguage(input, name);
